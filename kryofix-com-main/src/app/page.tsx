...
export const metadata: Metadata = {
  title: 'KryoFix - Instalación y Reparación de Aire Acondicionado en CABA y GBA',
  description: 'Servicios técnicos especializados en climatización. Instalación, mantenimiento y reparación de aires acondicionados. Técnicos certificados en CABA y Gran Buenos Aires. ¡Contactanos por WhatsApp!',
  keywords: 'aire acondicionado, instalación aire acondicionado, reparación aire acondicionado, mantenimiento aire acondicionado, técnico aire acondicionado, CABA, GBA, Buenos Aires, climatización, split, multisplit',
  ...
  openGraph: {
    ...
    description: 'Instalación, reparación y mantenimiento de aires acondicionados. Técnicos certificados en CABA y GBA. Contactanos por WhatsApp.',
    type: 'website',
    locale: 'es_AR',
    siteName: 'KryoFix',
  },
  twitter: {
    ...
    title: 'KryoFix - Servicios de Aire Acondicionado',
    description: 'Instalación, reparación y mantenimiento de aires acondicionados en Buenos Aires.',
  },
  alternates: {
    canonical: 'https://kryofix.com',
  },
};
